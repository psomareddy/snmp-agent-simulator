...
public class SNMPAgent extends BaseAgent {
	...
	public static void createManagedObjects(SNMPAgent agent) throws Exception {
		...
		agent.registerManagedObject(
				new MOScalar<OctetString>(sysDescr, MOAccessImpl.ACCESS_READ_ONLY, new OctetString("New Relic sample agent for testing nri-snmp integration")));
		...
		//incidentCountMO
		incidentCountMO = new MOScalar<Counter32>(new OID(".1.3.6.1.4.1.52032.1.1.2.0"), 
				MOAccessImpl.ACCESS_READ_ONLY, new Counter32(3));
		agent.registerManagedObject(incidentCountMO);
		
		//descriptionMO
		descriptionMO = new MOScalar<OctetString>(new OID(".1.3.6.1.4.1.52032.1.1.3.0"), 
